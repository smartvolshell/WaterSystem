...
<body>
	<div id="footer_bot">
		<p>
			Copyright 2016.
			<!-- Do not remove -->
			Designed by <a href="http://www.cnblogs.com/plxx"
				title="Smart Volshell">Smart Volshell</a>
			<!-- end -->
		</p>
		<p>
			<a href="#">Privacy Policy</a> | <a href="#">Terms of Use</a> | <a
				href="#" title="This page validates as XHTML 1.0 Transitional"><abbr
				title="eXtensible HyperText Markup Language">XHTML</abbr></a> | <a
				href="#" title="This page validates as CSS"><abbr
