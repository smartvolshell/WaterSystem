											...
											<div class="more-views-container">
												<ul>
													<li><a class="cs-fancybox-thumbs"
														data-fancybox-group="thumb" href="" title="" alt=""> <img
															src="" src_main="" title="" alt="" /></a></li>
													<li><a class="cs-fancybox-thumbs"
														data-fancybox-group="thumb" href="" title="" alt=""> <img
															src="" src_main="" title="" alt="" /></a></li>
													<li><a class="cs-fancybox-thumbs"
							...
							<div class="desc1">
								...
								<div class="available">
									...
									<p>It is a long established fact that a reader will be
										distracted by the readable contentContrary to popular belief,
										Lorem Ipsum is not simply random text. It has roots in a piece
										of classical Latin literature from of a page when looking at
										its layout.</p>
								</div>
						...
						<div class="left_content_btm">
							...
							<section class="tabs">
								<input id="tab-1" type="radio" name="radio-set"
									...
									for="tab-1" class="tab-label-1">overview</label> <input
									id="tab-2" type="radio" name="radio-set" class="tab-selector-2">
								<label for="tab-2" class="tab-label-2">consumer</label> <input
								...
								<div class="content">
									<div class="content-1">
										<p class="para top">
											<span>LOREM IPSUM</span> There are many variations of
											...
											a dictionary of over 200 Latin words, combined
										</p>
										<ul>
											<li>Research</li>
									...
									<div class="content-2">
										<p class="para">
											<span>WELCOME </span> Contrary to popular belief, Lorem Ipsum
					...
					<div class="left_sidebar">
						...
						<div class="left_products">
							...
							<div class="left_text">
								...
								<span class="line">$72.00</span> <span>$52.00</span>
							</div>
							<div class="clear"></div>
						</div>
						<div class="left_products">
							...
							<div class="left_text">
								...
								<span class="line">$86.00</span> <span>$83.00</span>
							</div>
							<div class="clear"></div>
						</div>
						<div class="left_products">
							...
							<div class="left_text">
								...
								<span class="line">$76.00</span> <span>$75.00</span>
							</div>
							<div class="clear"></div>
						</div>
